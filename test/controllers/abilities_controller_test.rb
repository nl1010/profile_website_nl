...
class AbilitiesControllerTest < ActionController::TestCase
  ...
  test "should create ability" do
    assert_difference('Ability.count') do
      post :create, ability: { detail: @ability.detail, name: @ability.name, professioncy: @ability.professioncy }
    end
  ...
  test "should update ability" do
    patch :update, id: @ability, ability: { detail: @ability.detail, name: @ability.name, professioncy: @ability.professioncy }
    assert_redirected_to ability_path(assigns(:ability))
  end
