...
class EducationsControllerTest < ActionController::TestCase
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post :create, education: { detail: @education.detail, end_date: @education.end_date, facility_name: @education.facility_name, start_date: @education.start_date, subject: @education.subject, transcript: @education.transcript }
    end
  ...
  test "should update education" do
    patch :update, id: @education, education: { detail: @education.detail, end_date: @education.end_date, facility_name: @education.facility_name, start_date: @education.start_date, subject: @education.subject, transcript: @education.transcript }
    assert_redirected_to education_path(assigns(:education))
  end
